...
public class ThemeManager {
    ...
    public static final Color PRIMARY_COLOR = new Color(18, 40, 42); // Modern Blue
    ...
    public static final Color WHITE = Color.WHITE;
        ...
        public static void applyTheme() {
            ...
            UIManager.getLookAndFeelDefaults().put("Button[Focused].backgroundPainter", normalPainter);
